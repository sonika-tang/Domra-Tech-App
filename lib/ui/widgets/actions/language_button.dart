...
class LanguageButton extends StatelessWidget {
  ...
  const LanguageButton({super.key, required this.language, required this.imagePath, required this.onSelected, this.isSelected = true});
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const Spacer(),
            // Selection icon
            Icon(isSelected ? Icons.check_circle : Icons.radio_button_unchecked, color: colorScheme.secondary),
          ],
        ),
      ),
    );
