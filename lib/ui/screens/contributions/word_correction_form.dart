                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          final data = {
                            ...
                            'correctKhmerWord': _khmerController.text.isEmpty
                                ? null
                                : _khmerController.text,
                            'correctFrenchWord': _frenchController.text.isEmpty
                                ? null
                          ...
                          final success = await notifier.submitCorrection(
                            data,
                          ...
                          if (mounted) {
                            if (success) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    notifier.state.error ?? 'Submission failed',
                                  ),
